...
public class Servicio_factura {
    ...
    public void GenerarFacturacion(String perioIni, String periodoFin, String fePago, String Fesus, String nota) {
        ...
        String GuardaPeriodo = InsertarPeriodo(perioIni, periodoFin,Fesus, fePago);
...
//    "Parametro String fechaActual = "+fechaActual+"\n");  
    ...
    public String ConsultarPeriodo(String inicio, String fin, String corte, String pago){
        String resultado = "";
        try {
            String sql = "SELECT periodoInicial,"
                    + "periodoFin, "
                    + "fechaPago,"
                    + "fechaSuspencion ," 
                    + "estado "
                    + "From periodos "
                    + "WHERE periodoInicial ='" + inicio + "' "
                    + "AND periodoFin ='" + fin + "' "
                    + "AND fechaPago ='" + pago + "' "
                    + "AND fechaSuspencion ='" + corte + "'";
            ...
            res1.next();
            if (res1.next()) {
                resultado = res1.getString("estado");
            }
            res1.close();
        } catch (SQLException e) {
            System.out.println(e);
    ...
    public String InsertarPeriodo(String inicio, String fin, String corte, String pago){
        String resultado = "";
        ...
        try {
            java.sql.PreparedStatement pstm = 
                    (java.sql.PreparedStatement) conm
                    .getConnection()
                    .prepareStatement("INSERT INTO periodos (id, periodoInicial, periodoFin, fechaPago, fechaSuspencion, estado) "
                    + "VALUES " 
                    + "(NULL, '"+inicio+"','"+fin+"', '"+corte+"','"+pago+"', 1) ");
            pstm.execute();
            pstm.close();

            resultado = "Periodo Creado";

        } catch (SQLException e) {
            System.out.println(e);
            resultado = "ERROR AL CREA EL PERIODO";
        }
        return resultado;
    }
    ...
    public String VerificarPeriodo(String inicio, String fin, String corte, String pago) {
        ...
        try {
            String sql = "SELECT "
                    + "periodo_facturacion_inicial as inicial, "
                    + "periodo_facturacion_final as final, "
                    + "fecha_de_pago as pago, fecha_suspencion as corte  "
                    + "from factura "
                    + "where periodo_facturacion_inicial='" + inicio + "' "
                    + "and periodo_facturacion_final='" + fin + "' "
                    + "and fecha_de_pago='" + pago + "' "
                    + "and fecha_suspencion='" + corte + "'";
