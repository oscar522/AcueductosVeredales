...
public class Servicio_deuda {
      ...
      ResultSet res = null;
            PreparedStatement pstm = (PreparedStatement) conm.getConnection().prepareStatement( "SELECT  count(*) as total from inmueble i, cliente c, deudor d, factura f where d.codigo_factura = f.codigo_factura and i.codigo_inmueble = f.codigo_inmueble and d.estado = 'AC' and i.codigo_inmueble = '" +CODIGO+ "'");
        ...
        try{ 
               PreparedStatement pstm = (PreparedStatement) conm.getConnection().prepareStatement("select " +
                       ...
                       "where d.codigo_factura = f.codigo_factura and i.codigo_inmueble = f.codigo_inmueble and c.documento = i.documento and d.estado = 'AC' and i.codigo_inmueble = "+CODIGO+ " ");
           ...
           while(res.next()){
            ...
            String deuda = res.getString("iddeuda");
