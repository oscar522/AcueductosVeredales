...
public class Servicio_cierre {
   ...
   public Servicio_cierre (){
     ...
     public void ConsultarNuevosDeudores(String fecha_de_corte){
         ...
         try{
            PreparedStatement pstm = (PreparedStatement) conm.getConnection().prepareStatement("SELECT f.otros_conceptos as otros_conceptos, f.codigo_financiacion_deuda as codigo_financiacion_deuda, f.codigo_financiacion as codigo_financiacion, f.codigo_factura as codigo_factura, f.fecha_de_pago as fecha_de_pago  FROM factura f  WHERE f.codigo_factura NOT IN(SELECT p.codigo_factura FROM pago_factura p) and f.fecha_suspencion='"+fecha_de_corte+"'");
    ...
    public String ConsultarFactura(String fecha_suspencion){
         ...
         String valor = "";
         try{
            PreparedStatement pstm = (PreparedStatement) conm.getConnection().prepareStatement("SELECT  f.codigo_factura as codigo_factura, f.fecha_de_pago as fecha_de_pago  FROM factura f  WHERE f.fecha_suspencion='"+fecha_suspencion+"'");
     ...
     String fechade ="";
     try{
     String sql="SELECT f.fecha_suspencion as fecha from factura f, deudor d where f.codigo_factura = d.codigo_factura and f.fecha_suspencion='"+Fechacorte+"' and d.tipo = 'cierre'";
