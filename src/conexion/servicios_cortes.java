...
public class servicios_cortes {
    ...
    public void InsertReconec(String codigo_factura, String fecha_pago, String nombreacu) {
        ...
        int numeroinser = 0;
        try {
            PreparedStatement pstm = (PreparedStatement) conm.getConnection().prepareStatement("SELECT nombre, idservicio FROM servicio  WHERE nombre LIKE '%" + nombreacu + "%' AND  CodServicio = 4");
        ...
        try {
            String q = "";// INSERTAR LA RECONEXCION DEPENDIENDO EL CASO
